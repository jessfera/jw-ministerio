              ...
              <tr key={r.id}>
                ...
                <td>
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      onUpdate(r.id, {
                        pioneiroAuxiliar: checked,
                        // PA e PR não podem ficar marcados ao mesmo tempo
                        pioneiroRegular: checked ? false : !!r.pioneiroRegular,
                        // Se desmarcar PA, zera horas PA
                        horasPA: checked ? (r.horasPA ?? 0) : 0,
                      });
                    }}
                  />
                </td>
                ...
                <td>
                  <input
                    ...
                    onChange={(e) => {
                      const checked = e.target.checked;
                      onUpdate(r.id, {
                        pioneiroRegular: checked,
                        // PA e PR não podem ficar marcados ao mesmo tempo
                        pioneiroAuxiliar: checked ? false : !!r.pioneiroAuxiliar,
                        // Se desmarcar PR, zera horas PR
                        horasPR: checked ? (r.horasPR ?? 0) : 0,
                      });
                    }}
                  />
                </td>
                ...
                <td>
                  <input
                    ...
                    disabled={readOnly}
                    onChange={(e) =>
                      onUpdate(r.id, { estudosBiblicos: numInput(e.target.value) })
                    }
                    style={{ width: 90 }}
                    min={0}
                  />
